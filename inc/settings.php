...
class Settings {
    ...
    public function __construct($connect = true) {
        ...
        $this->host = 'de13.falixnodes.net';
        $this->port = 3306;

        $this->database = 's56566_litebans';

        $this->username = 'u56566_hHtbHZl8Eb';
        $this->password = '@ERNFkMQ5S!lvRbr@.DfmxHO';
